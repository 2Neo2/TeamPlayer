//
//  TitlePlaylistCollectionReusableView.swift
//  TeamPlayer
//
...
class TitlePlaylistCollectionReusableView: UICollectionReusableView {
    static let identifier = "TitlePlaylistCollectionReusableView"
    ...
    private lazy var infoSectionTitleLabel: UILabel = {
        ...
        label.text = "Плейлист сообщества"
        return label
    }()
...
extension TitlePlaylistCollectionReusableView {
